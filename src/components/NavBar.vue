  ...
  <header class="header z-40">
    ...
    <nav class="nav">
      ...
      <div class="right" print:op0>
        ...
        <a href="https://github.com/Casheeew" target="_blank" title="GitHub" class="lt-md:hidden">
          <div i-uil-github-alt />
        </a>
        <a href="https://www.linkedin.com/in/son-nghiem-xuan/" target="_blank" title="LinkedIn" class="lt-md:hidden">
